...
class ArrayHelper {
     ...
     */
    public static function pluck( array $vars, string $field, bool $preserve_keys = true ): array {
        $values = [];
        foreach( $vars as $k => $v ) {
     ...
     */
    public static function sum( array $vars, string $field ) {
     ...
     */
    public static function min( array $vars, string $field ) {
     ...
     */
    public static function max( array $vars, string $field ) {
