...
class VarDumper implements Dumper {
    ...
    public function dumpBoolean( $var ): string {
        return sprintf('bool(%s)', $var ? 'true' : 'false');
    }

    public function dumpInteger( $var ): string {
        return "int({$var})";
    }

    public function dumpFloat( $var ): string {
        return "float({$var})";
    }

    public function dumpString( $str ): string {
    ...
    public function dumpObject( $obj ): string {
    ...
    protected function dumpMeta( $meta ): string {
